...
test('Inventory Browse, enter unit, update unit field (category)', async ({ page })=>{
  await page.goto('https://ims-f-e-duno.vercel.app/portfolio');
  ...
  await page.getByText('category #2').click();
